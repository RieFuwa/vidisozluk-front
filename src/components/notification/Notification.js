...
export default function Notfication(props) {
  ...
  return (
    <>
      <button
        class=" text-white bg-lime-600 px-2 py-1 rounded-lg mt-2 duration-200 hover:bg-lime-700  align-middle  text-lg"
        type="button"
              ...
              <div className=" border-2 border-lime-600 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className=" items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  ...
                  <div class="flex flex-col justify-between">
                    ...
                    <p class="text-sm ">kullanıcı id'si: </p>
                    <p class="text-sm ">
                      baslık acılma tarihi:
                    </p>
                  </div>
